...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Провести эксериментальное исследование предложенной реализации 
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Ключевые особенности выбранного алгоритма, важные для решения поставленных щадач    
  \end{itemize}
\end{frame}
...
\begin{frame}[t]
  ...
  \begin{itemize}
    ...
    \item На каком обарудовании проводилось исследование    
...
\begin{itemize}
  \item Много дополнитеьных слайдов не надо: 1--2 вполне достатчно в большинстве случаев
  \item Кроме формул здесь могут быть схемы, рисунки, таблицы и другие вспомогятельные материалы
\end{itemize}
